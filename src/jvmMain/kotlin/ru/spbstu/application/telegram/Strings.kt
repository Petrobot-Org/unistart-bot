...
object Strings {
    ...
    const val Ideas = "Шаг Генерация идей"
    const val Step1 = "Шаг 1"
    const val Step2 = "Шаг 2"
    const val Step3 = "Шаг 3"
    const val Step4 = "Шаг 4"
    const val Button1 = "Бисоциации "
    const val Button2 = "Метод Дельфи/брейншторм "
    const val Button3 = "SCAMPER"
    const val Button4 = "Trendy Friendy "
    const val BBack = "Обратно к шагам"
}
